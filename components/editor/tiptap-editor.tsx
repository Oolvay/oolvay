...
import { PostSettingsModal } from "@/app/blog/components/post-settings-modal"
...
export function TiptapEditor({
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center gap-3">
        <input
          ...
          placeholder="Title…"
          className="w-full bg-transparent text-4xl font-bold placeholder:text-muted-foreground/50 outline-none leading-tight"
        />
        <TitleCaseButton
          onClick={() => setTitle(titleCase(title.toLowerCase()))}
        />
      </div>
      {/* Logline */}
      <div className="flex items-center gap-3">
        <input
          ...
          className="w-full bg-transparent text-xl placeholder:text-muted-foreground/50 outline-none leading-tight"
        />
        <TitleCaseButton
  ...
  "
      ...
      <div
        className={`fixed right-6 z-50 flex items-center gap-2 transition-all duration-200 ${footerVisible ? "bottom-20" : "bottom-6"}`}
      >
